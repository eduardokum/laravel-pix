...
class Cob extends Api implements ConsumesCobEndpoints, FilterApiRequests
{
    ...
    {
        $endpoint = $this->getEndpoint($this->getPsp()->getCurrentConfig('base_url') . $this->resolveEndpoint(Endpoints::CREATE_COB) . $transactionId);
    ...
    {
        $endpoint = $this->getEndpoint($this->getPsp()->getCurrentConfig('base_url') . $this->resolveEndpoint(Endpoints::CREATE_COB));
    ...
    {
        $endpoint = $this->getEndpoint($this->getPsp()->getCurrentConfig('base_url') . $this->resolveEndpoint(Endpoints::GET_COB) . $transactionId);
    ...
    {
        $endpoint = $this->getEndpoint($this->getPsp()->getCurrentConfig('base_url') . $this->resolveEndpoint(Endpoints::UPDATE_COB) . $transactionId);
    ...
    public function all(): Response
    {
        ...
        $endpoint = $this->getEndpoint($this->getPsp()->getCurrentConfig('base_url') . $this->resolveEndpoint(Endpoints::GET_ALL_COBS));
