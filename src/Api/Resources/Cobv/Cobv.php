...
class Cobv extends Api implements FilterApiRequests, ConsumesCobvEndpoints
{
    ...
    {
        $endpoint = $this->getEndpoint($this->getPsp()->getCurrentConfig('base_url') . $this->resolveEndpoint(Endpoints::CREATE_COBV) . $transactionId);
    ...
    {
        $endpoint = $this->getEndpoint($this->getPsp()->getCurrentConfig('base_url') . $this->resolveEndpoint(Endpoints::GET_COBV) . $transactionId);
    ...
    public function all(): Response
    {
        ...
        $endpoint = $this->getEndpoint($this->getPsp()->getCurrentConfig('base_url') . $this->resolveEndpoint(Endpoints::GET_ALL_COBV));
